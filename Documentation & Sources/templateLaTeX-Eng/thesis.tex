...
\pagestyle{headings}
	...
	Nowadays, in Romanian schools, teachers use C or Pascal programming languages and software related to these in order to develop the students' ideas regarding computer science and programming basics and paradigms.
...
A lexical analyzer is an analyzer which processes the source code, being the first step for compiling. It takes the modified source code from language preprocessors 
